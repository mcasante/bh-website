        ...
        <div className="w-full max-w-3xl">
          ...
          >
            <p className="text-md text-justify font-thin">
              Hey there! 👋 I'm a <b>frontend developer</b> living on the edge. I work primarily with <b>Vue.js</b> and <b>Nuxt</b>, but I can also write <b>React</b> and <b>Next.js</b> too.<br/><br/>
